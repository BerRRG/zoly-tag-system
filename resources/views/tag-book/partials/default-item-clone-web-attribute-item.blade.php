...
<div class="row">
    ...
    <div class="col-sm-3">
        <div class="form-group">
            {{ form::label('attribute[0][fields_to_set_no_interaction]', 'Fields to Set(noInteraction)') }}
            {{ form::text('attribute[0][fields_to_set_no_interaction]', input::old('attribute[0][fields_to_set_no_interaction]'), array('class' => 'form-control')) }}
        </div>
    </div>
    <div class="col-sm-3">
        <div class="form-group">
            {{ form::label('attribute[0][fields_to_set_type]', 'Fields to Set(type)') }}
            {{ form::select('attribute[0][fields_to_set_type]', $webAttribute->fieldSetTypes, input::old('attribute[0][fields_to_set_type]'), array('class' => 'form-control')) }}
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-3">
        <div class="form-group">
            {{ form::label('attribute[0][fields_to_set_example]', 'Fields to Set(example)') }}
            {{ form::text('attribute[0][fields_to_set_example]', input::old('attribute[0][fields_to_set_example]'), array('class' => 'form-control')) }}
        </div>
    </div>
    <div class="col-sm-3">
        <div class="form-group">
